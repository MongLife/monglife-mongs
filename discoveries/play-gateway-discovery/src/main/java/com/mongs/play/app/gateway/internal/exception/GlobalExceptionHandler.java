package com.mongs.play.app.gateway.internal.exception;
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable e) {
        ...
        if (e instanceof NotFoundException || e instanceof ConnectException || e instanceof WebClientRequestException) {
            return setErrorResponse(exchange, GatewayExternalErrorCode.CONNECT_FAIL);
        } else if (e instanceof GatewayExternalException) {
