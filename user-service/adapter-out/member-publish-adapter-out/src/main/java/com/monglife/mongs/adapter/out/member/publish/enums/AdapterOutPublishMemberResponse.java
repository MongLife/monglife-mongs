...
public enum AdapterOutPublishMemberResponse implements Response {
    ...
    MEMBER_PUBLISH_MEMBER_STAR_POINT(HttpStatus.OK.value(), "PUBLISH-MEMBER-000", "회원 스타 포인트에 변동이 있습니다."),
    MEMBER_PUBLISH_MEMBER_SLOT_COUNT(HttpStatus.OK.value(), "PUBLISH-MEMBER-001", "회원 슬롯 수에 변동이 있습니다."),
    ;
