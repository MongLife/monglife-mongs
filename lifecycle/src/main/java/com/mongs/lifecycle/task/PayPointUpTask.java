...
@Slf4j
@Builder
public class PayPointUpTask extends TimerTask implements BasicTask {
    ...
    public static PayPointUpTask of(TaskService taskService, TaskActiveService taskActiveService, MongEvent event) {
        return PayPointUpTask.builder()
    ...
    public void stop() {
        ...
        taskActiveService.increasePayPoint(event);
        timer.cancel();
        timer.purge();
