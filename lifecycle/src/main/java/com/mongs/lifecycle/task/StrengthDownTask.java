...
@Slf4j
@Builder
public class StrengthDownTask extends TimerTask implements BasicTask {
    ...
    public static StrengthDownTask of(TaskService taskService, TaskActiveService taskActiveService, MongEvent event) {
    ...
    public void stop() {
        ...
        taskActiveService.decreaseStrength(event);
        timer.cancel();
        timer.purge();
