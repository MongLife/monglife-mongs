...
//    ;
    ...
    // 주기적 감소
    WEIGHT_DOWN(15L, 5D),             // 15 초에 0.5 감소
    STRENGTH_DOWN(15L, 5D),           // 15 초에 0.5 감소
    SATIETY_DOWN(15L, 5D),            // 15 초에 0.5 감소
    HEALTHY_DOWN(15L, 5D),            // 15 초에 0.5 감소
    SLEEP_DOWN( 15L, 5D),             // 15 초에 0.5 감소
    ...
    // 죽음 (조건)
    DEAD_SATIETY(15L, -1D),            // 1 시간 이후 사망 (포만감 0 조건)
    DEAD_HEALTHY(15L, -1D),            // 1 시간 이후 사망 (포만감 0 조건)
    ;
