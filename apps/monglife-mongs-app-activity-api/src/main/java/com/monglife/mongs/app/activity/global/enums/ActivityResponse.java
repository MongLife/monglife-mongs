package com.monglife.mongs.app.activity.global.enums;
...
@Getter
@AllArgsConstructor
public enum ActivityResponse implements Response {
     ...
     * 실패 응답
     */
    ACTIVITY_BATTLE_NOT_EXISTS_BATTLE_RESPONSE(HttpStatus.NOT_ACCEPTABLE.value(), "ACTIVITY-BATTLE-100", "유효한 응답이 없습니다."),
    ...
    ACTIVITY_BATTLE_ONLY_BOT_MATCHING(HttpStatus.NOT_ACCEPTABLE.value(), "ACTIVITY-BATTLE-105", "봇으로만 매칭이 이루어졌습니다."),
    ACTIVITY_BATTLE_ALREADY_EXISTS_ROUND(HttpStatus.BAD_REQUEST.value(), "ACTIVITY-BATTLE-106", "이미 라운드 선택이 끝났습니다."),
