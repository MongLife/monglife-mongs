package com.mongs.play.app.auth.internal.controllerAdvice;

import com.mongs.play.app.auth.internal.controller.AuthInternalController;
...
@RestControllerAdvice(basePackageClasses = AuthInternalController.class)
public class AuthInternalControllerAdvice {
    ...
    public ResponseEntity<Object> authExternalExceptionHandler(AuthInternalException e) {
