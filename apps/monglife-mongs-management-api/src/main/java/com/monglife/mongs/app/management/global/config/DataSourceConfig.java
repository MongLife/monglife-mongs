package com.monglife.mongs.app.management.global.config;
...
@EnableJpaRepositories(
        basePackages = "com.monglife.mongs.app.management.data.repository",
...
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager(
        ...
        em.setPackagesToScan("com.monglife.mongs.app.management.data.entity");
