...
import com.monglife.mongs.adapter.in.member.web.feedback.dto.request.CreateFeedbackRequestDto;
...
public class FeedbackController {
    ...
    public ResponseEntity<ResponseDto<?>> createFeedback(
        ...
        return ResponseEntity.ok(AdapterInWebMemberResponse.CREATE_FEEDBACK.toResponseDto());
    }
}
