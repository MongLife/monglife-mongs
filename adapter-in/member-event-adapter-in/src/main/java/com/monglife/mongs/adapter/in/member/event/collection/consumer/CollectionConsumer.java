package com.monglife.mongs.adapter.in.member.event.collection.consumer;

import com.monglife.module.common.kafka.event.TransactionEvent;
import com.monglife.mongs.adapter.in.member.event.transaction.CreateCollectionMongEventDto;
...
public class CollectionConsumer {
     ...
     */
    @KafkaListener(topics = "commit.createCollectionMong")
