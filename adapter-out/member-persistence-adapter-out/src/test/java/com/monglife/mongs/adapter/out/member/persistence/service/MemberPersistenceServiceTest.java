...
class MemberPersistenceServiceTest {
    ...
    class CreatePlayerPort {
        ...
        void createPlayer() {
            ...
            assertEquals(accountId, playerOptional.get().getAccountId());
    ...
    class IsExistsPlayerPort {
        ...
        void isExistsPlayerWhenExistPlayer() {
            ...
            // act
            boolean expected = memberPersistencePort.isExistsPlayerPort(accountId);
    ...
    class GetPlayerPort {
        ...
        void getPlayer() {
            ...
            // act
            Optional<Player> playerOptional = memberPersistencePort.getPlayerPort(accountId);
