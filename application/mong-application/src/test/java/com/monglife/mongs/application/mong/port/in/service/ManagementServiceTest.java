...
import com.monglife.mongs.domain.exception.ForbiddenMongException;
import com.monglife.mongs.domain.exception.InvalidEvolutionException;
...
class ManagementServiceTest {
    ...
    public ManagementServiceTest() {
        ...
        this.managementUseCase = new ManagementService(mongPersistencePort, mongEventPort);
    }
    ...
    class GetMongsUseCase{
        ...
        void getMongs() {
            ...
            Mockito.when(mongPersistencePort.getMongsPort(accountId)).thenReturn(mongs);
    ...
    class StrokeMongUseCase{
        ...
        void strokeMong() {
            ...
            Mockito.when(mongPersistencePort.getMongPort(mongId)).thenReturn(Optional.of(mong));
            Mockito.when(mongPersistencePort.getMongStrokeExpirationSecondsPort(mongId)).thenReturn(nowExpirationSeconds);
