...
class ActivityServiceTest {
    ...
    class GetTrainingTypesUseCase {
        ...
        void getTrainingTypes() {
            ...
            Mockito.when(mongPersistencePort.getTrainingTypesPort()).thenReturn(trainingTypes);
    ...
    class GetTrainingTypeUseCase {
        ...
        void getTrainingType() {
            ...
            Mockito.when(mongPersistencePort.getTrainingTypePort(trainingTypeCode)).thenReturn(Optional.of(trainingType));
        ...
        void getTrainingTypeWhenNotExistsTrainingType() {
            ...
            Mockito.when(mongPersistencePort.getTrainingTypePort(trainingTypeCode)).thenReturn(Optional.empty());
