...
@Setter
@NoArgsConstructor
public class UseInventoryResponseDto {
    ...
    @Builder
    public UseInventoryResponseDto(Long mongId, Integer payPoint, Double expRatio, Double strengthRatio, Double healthyRatio, Double satietyRatio, Double fatigueRatio, Double weight, MongStateCode stateCode, MongStatusCode statusCode) {
        this.mongId = mongId;
