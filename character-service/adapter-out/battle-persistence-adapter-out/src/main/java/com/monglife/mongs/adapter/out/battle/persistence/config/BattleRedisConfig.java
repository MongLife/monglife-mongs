package com.monglife.mongs.adapter.out.battle.persistence.config;
...
public class BattleRedisConfig {
    ...
    public RedisTemplate<String, ?> mongRedisTemplate(@Qualifier(REDIS_CONNECTION_FACTORY_NAME) RedisConnectionFactory redisConnectionFactory){
        ...
        redisTemplate.setValueSerializer(new Jackson2JsonRedisSerializer<>(objectMapper, QueuePlayerEntity.class));
