...
public enum ApplicationMongErrorCode implements ErrorCode {
    ...
    INVALID_CREATE_MONG_FEED_HISTORY("APPLICATION-MONG-011", "몽 섭취 이력 등록에 실패했습니다."),
    INVALID_DELETE_INVENTORY_ITEM("APPLICATION-MONG-012", "인벤토리 아이템 삭제에 실패했습니다."),
    INVALID_CREATE_MONG_SCHEDULE("APPLICATION-MONG-013", "몽 스케줄 등록에 실패했습니다."),
    ;
