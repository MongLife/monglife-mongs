...
@Setter
@NoArgsConstructor
public class DecreaseMongStatusRatioDto {
    ...
    @Builder
    public DecreaseMongStatusRatioDto(Double exp, Double weight, Double strengthRatio, Double satietyRatio, Double healthyRatio, Double fatigueRatio, Integer poopCount) {
        this.exp = exp;
        this.weight = weight;
