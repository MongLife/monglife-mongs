...
@Setter
@NoArgsConstructor
public class DecreaseMongStatusDto {
    ...
    @Builder
    public DecreaseMongStatusDto(Double exp, Double weight, Double strengthRatio, Double satietyRatio, Double healthyRatio, Double fatigueRatio, Integer poop) {
        this.exp = exp;
        this.weight = weight;
