...
@Setter
@NoArgsConstructor
public class IncreaseMongStatusRatioDto {
    ...
    @Builder
    public IncreaseMongStatusRatioDto(Double exp, Double weight, Double strengthRatio, Double satietyRatio, Double healthyRatio, Double fatigueRatio, Integer poopCount) {
        this.exp = exp;
        this.weight = weight;
