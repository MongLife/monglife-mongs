...
@Getter
@ToString
public class MongHistoryObserveEvent {
    ...
    @Builder
    public MongHistoryObserveEvent(Long mongId, String mongName, Integer payPoint, MongStateCode stateCode, String mongTypeCode, Boolean isSleep, MongStatusCode statusCode, Double weight, Double expRatio, Double strengthRatio, Double satietyRatio, Double healthyRatio, Double fatigueRatio, Integer poopCount, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.mongId = mongId;
    ...
    public static MongHistoryObserveEvent of(MongEntity mongEntity) {
        return MongHistoryObserveEvent.builder()
