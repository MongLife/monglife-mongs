...
public enum MatchResponse implements Response {
     ...
     * 실패 응답
     */
    DOMAIN_MATCH_NOT_EXISTS_WAIT_MATCHING(HttpStatus.BAD_REQUEST.value(), "DOMAIN-BATTLE-102", "매칭 대기열이 존재하지 않습니다."),
    DOMAIN_MATCH_NOT_EXISTS_ROOM_ID(HttpStatus.BAD_REQUEST.value(), "DOMAIN-BATTLE-103", "존재하지 않는 배틀 룸 ID 입니다."),
