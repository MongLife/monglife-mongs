...
public enum MatchResponse implements Response {
    ...
    DOMAIN_MATCH_NOT_EXISTS_MONG_ID(HttpStatus.BAD_REQUEST.value(), "DOMAIN-MATCH-102", "존재하지 않는 몽 ID 입니다."),
    DOMAIN_MATCH_NOT_EXISTS_MONG_TYPE(HttpStatus.BAD_REQUEST.value(), "DOMAIN-MATCH-103", "몽 타입이 존재하지 않습니다."),
    DOMAIN_MATCH_ONLY_BOT_MATCHING(HttpStatus.NOT_ACCEPTABLE.value(), "DOMAIN-MATCH-104", "봇으로만 매칭이 이루어졌습니다."),
    DOMAIN_MATCH_ALREADY_EXISTS_ROUND(HttpStatus.BAD_REQUEST.value(), "DOMAIN-MATCH-105", "이미 라운드 선택이 끝났습니다."),
    ;
