...
public enum MemberResponse implements Response {
    ...
    DOMAIN_MEMBER_NOT_ENOUGH_WALKING_COUNT(HttpStatus.BAD_REQUEST.value(), "DOMAIN-MONG-105", "충분한 걸음 수가 없습니다."),
    ...
    DOMAIN_MEMBER_NOT_EXISTS_MEMBER_STEP(HttpStatus.BAD_REQUEST.value(), "DOMAIN-MONG-108", "회원 걸음 수가 존재하지 않습니다."),
    ;
